...
#ifndef __LIKELIHOODTOPLEPTONJETS__H
#define __LIKELIHOODTOPLEPTONJETS__H
...
namespace KLFitter
{
	...
	protected: 
		...
		/**
		 * Delete the model particles.
		 * @return An error code.
		 */
		int DeleteModelParticles();
...
#endif // __LIKELIHOODTOPLEPTONJETS__H
