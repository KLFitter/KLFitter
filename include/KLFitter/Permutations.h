...
class Permutations final {
 public:
   ...
   * @return An error code.
   */
  int InvariantParticlePermutations(KLFitter::ParticleCollection::ParticleType ptype, std::vector<int> indexVector);
   ...
   * @return An error code.
   */
  int InvariantParticleGroupPermutations(KLFitter::ParticleCollection::ParticleType ptype, std::vector<int> indexVectorPosition1,  std::vector<int> indexVectorPosition2);
   ...
   * @return An error code.
   */
  int RemoveParticlePermutations(KLFitter::ParticleCollection::ParticleType ptype, int index, int position);
