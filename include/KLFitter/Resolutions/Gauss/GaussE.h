...
#ifndef KLFITTER_RESOLUTIONS_GAUSS_GAUSSE_H_
#define KLFITTER_RESOLUTIONS_GAUSS_GAUSSE_H_
 ...
 */
class GaussE : public GaussBase {
 public:
  /// The default constructor.
  explicit GaussE(const char * filename);

  /**
   * A constructor.
   * @param sigma The width of the Gaussian.
   */
  explicit GaussE(double sigma);

  /**
   * A constructor.
   * @param sigma The width of the Gaussian.
   */
  explicit GaussE(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_GAUSS_GAUSSE_H_
