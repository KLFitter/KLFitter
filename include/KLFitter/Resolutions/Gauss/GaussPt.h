...
#ifndef KLFITTER_RESOLUTIONS_GAUSS_GAUSSPT_H_
#define KLFITTER_RESOLUTIONS_GAUSS_GAUSSPT_H_
 ...
 */
class GaussPt : public GaussBase {
 public:
  /// The default constructor.
  explicit GaussPt(const char * filename);

  /**
   * A constructor.
   * @param sigma The width of the Gaussian.
   */
  explicit GaussPt(double sigma);

  /**
   * A constructor.
   * @param sigma The width of the Gaussian.
   */
  explicit GaussPt(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_GAUSS_GAUSSPT_H_
