...
#ifndef KLFITTER_RESOLUTIONS_GAUSS_GAUSSBASE_H_
#define KLFITTER_RESOLUTIONS_GAUSS_GAUSSBASE_H_
 ...
 */
class GaussBase : public ResolutionBase {
 public:
  /// The default constructor.
  explicit GaussBase(const char * filename);

  /**
   * A constructor.
   * @param sigma The width of the Gaussian.
   */
  explicit GaussBase(double sigma);

  /**
   * A constructor with parameters.
   * @param parameters.
   */
  explicit GaussBase(std::vector<double> const& parameters);
   ...
   * @return The width.
   */
  virtual double GetSigma(double par = 0) override;
...
#endif  // KLFITTER_RESOLUTIONS_GAUSS_GAUSSBASE_H_
