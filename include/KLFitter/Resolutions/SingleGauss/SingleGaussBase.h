...
#ifndef KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSBASE_H_
#define KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSBASE_H_
...
/**
  ...
  * parameters.
  */
class SingleGaussBase : public ResolutionBase {
 public:
  /**
    * The default constructor.
    */
  explicit SingleGaussBase(const char * filename);
  ...
  /**
    ...
    */
  explicit SingleGaussBase(std::vector<double> const& parameters);

  /**
    * The (defaulted) destructor.
    */
  virtual ~SingleGaussBase();
...
}  // namespace ingleGauss
}  // namespace Resolutions
}  // namespace KLFitter

#endif  // KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSBASE_H_
