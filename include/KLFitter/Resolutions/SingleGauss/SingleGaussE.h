...
#ifndef KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSE_H_
#define KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSE_H_
...
/**
  ...
  * parameters.
  */
class SingleGaussE : public SingleGaussBase {
 public:
  /**
    * The default constructor.
    */
  explicit SingleGaussE(const char * filename);
  ...
  /**
    ...
    */
  explicit SingleGaussE(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_SINGLEGAUSS_SINGLEGAUSSE_H_
