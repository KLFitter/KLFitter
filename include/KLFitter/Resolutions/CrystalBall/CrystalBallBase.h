...
#ifndef KLFITTER_RESOLUTIONS_CRYSTALBALL_CRYSTALBALLBASE_H_
#define KLFITTER_RESOLUTIONS_CRYSTALBALL_CRYSTALBALLBASE_H_
...
/**
  ...
  * parameters.
  */
class CrystalBallBase : public ResolutionBase {
 public:
  ///The default constructor.
  explicit CrystalBallBase(const char * filename);
  ...
  /**
    ...
    */
  explicit CrystalBallBase(std::vector<double> const& parameters);

  /**
    * The (defaulted) destructor.
    */
  virtual ~CrystalBallBase();
...
#endif  // KLFITTER_RESOLUTIONS_CRYSTALBALL_CRYSTALBALLBASE_H_
