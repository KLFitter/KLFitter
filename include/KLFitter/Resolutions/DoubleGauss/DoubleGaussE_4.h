...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_4_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_4_H_
 ...
 * parameters.
 */
class DoubleGaussE_4 : public DoubleGaussBase {
 public:
  /// The default constructor.
  explicit DoubleGaussE_4(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussE_4(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_4_H_
