...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_2_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_2_H_
 ...
 * parameters.
 */
class DoubleGaussE_2 : public DoubleGaussBase {
 public:
  /// The default constructor.
  explicit DoubleGaussE_2(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussE_2(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTION_DOUBLEGAUSS_DOUBLEGAUSSE_2_H_
