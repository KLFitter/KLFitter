...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSPT_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSPT_H_
 ...
 * parameters.
 */
class DoubleGaussPt : public DoubleGaussBase {
 public:
  /// The default constructor.
  explicit DoubleGaussPt(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussPt(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSPT_H_
