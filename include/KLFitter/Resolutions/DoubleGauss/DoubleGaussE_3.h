...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_3_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_3_H_
 ...
 * parameters.
 */
class DoubleGaussE_3 : public DoubleGaussBase {
 public:
  /// The default constructor.
  explicit DoubleGaussE_3(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussE_3(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTION_DOUBLEGAUSS_DOUBLEGAUSSE_3_H_
