...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_1_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_1_H_
 ...
 * parameters.
 */
class DoubleGaussE_1 : public DoubleGaussBase {
 public:
  /// The default constructor.
  explicit DoubleGaussE_1(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussE_1(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSE_1_H_
