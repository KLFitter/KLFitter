...
#ifndef KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSBASE_H_
#define KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSBASE_H_
 ...
 * parameters.
 */
class DoubleGaussBase : public ResolutionBase {
 public:
  /// The default constructor.
  explicit DoubleGaussBase(const char * filename);

  /**
   * A constructor.
   * @param parameters The parameters of the parameterization.
   */
  explicit DoubleGaussBase(std::vector<double> const& parameters);

  /// The (defaulted) destructor.
  virtual ~DoubleGaussBase();
...
#endif  // KLFITTER_RESOLUTIONS_DOUBLEGAUSS_DOUBLEGAUSSBASE_H_
