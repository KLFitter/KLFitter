...
#ifndef KLFITTER_PARTICLES_TAU_H_
#define KLFITTER_PARTICLES_TAU_H_
...
namespace Particle {
/**
 * Implementation of a tau class. This inherits a generic
 * structure from Particle::Base, reimplements all purely virtual
 * functions and adds functionality specific to taus.
 */
class Tau : public Base {
 public:
  /**
   * Tau constructor taking name and four momentum.
   * @param name The name of the particle
   * @param p4 The four momentum
   */
  Tau(const std::string& name, const TLorentzVector& p4)
    : m_name(name)
    , m_p4(p4) {
    // empty
  }
...
#endif  // KLFITTER_PARTICLES_TAU_H_
