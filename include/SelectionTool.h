...
#ifndef __SELECTIONTOOL__H
#define __SELECTIONTOOL__H
...
namespace KLFitter
{
	...
	public: 
		 ...
		 * @param dn Tolerance. 
		 * @return An error flag. */
		int RequireNElectronsPt(double pt, int n, int dn = 1); 
		 ...
		 * @param dn Tolerance. 
		 * @return An error flag. */ 
		int RequireNMuonsPt(double pt, int n, int dn = 1); 
		 ...
		 * @param dn Tolerance. 
		 * @return An error flag. */ 
		int RequireNPhotonsPt(double pt, int n, int dn = 1); 
		...
		/**
		 * Set jet pt cut. 
		 * @param pt The minimum pT. 
		 */ 
		void SelectJetPt(double pt) { fJetPt = pt; }; 
		 ...
		 * @param pt The minimum pT. 
		 */ 
		void SelectElectronPt(double pt) { fElectronPt = pt; }; 
		 ...
		 * @param pt The minimum pT. 
		 */ 
		void SelectMuonPt(double pt) { fMuonPt = pt; }; 
		 ...
		 * @param pt The minimum pT. 
		 */ 
		void SelectPhotonPt(double pt) { fPhotonPt = pt; }; 
