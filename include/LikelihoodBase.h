...
#ifndef __LIKELIHOODBASE__H
#define __LIKELIHOODBASE__H
...
namespace KLFitter
{
	...
	public: 
		 ...
		 */ 
		LikelihoodBase(Particles ** particles); 
		 ...
		 * @return An error flag. 
		 */ 
		int SetInitialParameters(std::vector <double> parameters); 
