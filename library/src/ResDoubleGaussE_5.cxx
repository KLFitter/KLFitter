...
// --------------------------------------------------------- 
KLFitter::ResDoubleGaussE_5::ResDoubleGaussE_5(const char * filename) : KLFitter::ResolutionBase(10)
{
...
// ---------------------------------------------------------
KLFitter::ResDoubleGaussE_5::ResDoubleGaussE_5(std::vector<double> const& parameters) : KLFitter::ResolutionBase(parameters)
{
  // check number of parameters 
  if (parameters.size() != 10)
    {
      std::cout << "KLFitter::ResDoubleGaussE_5::ResDoubleGaussE_5(). Number of parameters != 10." << std::endl;
      return;
    } 
}
...
// --------------------------------------------------------- 
double KLFitter::ResDoubleGaussE_5::p(double x, double xmeas, bool &good)
{
