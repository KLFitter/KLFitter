...
// --------------------------------------------------------- 
KLFitter::ResDoubleGaussE::ResDoubleGaussE(const char * filename) : KLFitter::ResolutionBase(10)
{
...
// ---------------------------------------------------------
KLFitter::ResDoubleGaussE::ResDoubleGaussE(std::vector<double> const& parameters) : KLFitter::ResolutionBase(parameters)
{
  // check number of parameters 
  if (parameters.size() != 10)
    {
      std::cout << "KLFitter::ResDoubleGaussE::ResDoubleGaussE(). Number of parameters != 10." << std::endl;
      return;
    } 
}

// --------------------------------------------------------- 
KLFitter::ResDoubleGaussE::~ResDoubleGaussE()
{
  ;
}

// --------------------------------------------------------- 
double KLFitter::ResDoubleGaussE::p(double x, double xmeas)
{
