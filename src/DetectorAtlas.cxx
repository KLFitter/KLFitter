...
{
	// energy resolution 
	fResEnergyLightJet_eta1 = new KLFitter::ResDoubleGauss("par_energy_light_eta1.txt"); 
	fResEnergyBJet_eta1     = new KLFitter::ResDoubleGauss("par_energy_b_eta1.txt"); 
	fResEnergyGluonJet_eta1 = new KLFitter::ResDoubleGauss("par_energy_gluon_eta1.txt"); 
	fResEnergyElectron_eta1 = new KLFitter::ResDoubleGauss("par_energy_electron_eta1.txt"); 
	...
	fResEnergyLightJet_eta2 = new KLFitter::ResDoubleGauss("par_energy_light_eta2.txt"); 
	fResEnergyBJet_eta2     = new KLFitter::ResDoubleGauss("par_energy_b_eta2.txt"); 
	fResEnergyGluonJet_eta2 = new KLFitter::ResDoubleGauss("par_energy_gluon_eta2.txt"); 
	fResEnergyElectron_eta2 = new KLFitter::ResDoubleGauss("par_energy_electron_eta2.txt"); 
	...
	fResEnergyLightJet_eta3 = new KLFitter::ResDoubleGauss("par_energy_light_eta3.txt"); 
	fResEnergyBJet_eta3     = new KLFitter::ResDoubleGauss("par_energy_b_eta3.txt"); 
	fResEnergyGluonJet_eta3 = new KLFitter::ResDoubleGauss("par_energy_gluon_eta3.txt"); 
	fResEnergyElectron_eta3 = new KLFitter::ResDoubleGauss("par_energy_electron_eta3.txt"); 
	...
	// phi resolution 
	fResPhiLightJet_eta1 = new KLFitter::ResGauss("par_eta_light_eta1.txt"); 
	fResPhiLightJet_eta2 = new KLFitter::ResGauss("par_eta_light_eta2.txt"); 
	fResPhiLightJet_eta3 = new KLFitter::ResGauss("par_eta_light_eta3.txt"); 

	fResPhiBJet_eta1 = new KLFitter::ResGauss("par_eta_b_eta1.txt"); 
	fResPhiBJet_eta2 = new KLFitter::ResGauss("par_eta_b_eta2.txt"); 
	fResPhiBJet_eta3 = new KLFitter::ResGauss("par_eta_b_eta3.txt"); 
