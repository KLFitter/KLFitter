...
KLFitter::DetectorAtlas_7TeV::DetectorAtlas_7TeV() : DetectorBase() 
{
  // energy resolution 
  fResEnergyLightJet_eta1 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_light_eta1_7TeV.txt"); 
  fResEnergyBJet_eta1     = new KLFitter::ResDoubleGaussE_2("./../../transferfunctions/ttbar/par_energy_b_eta1_7TeV.txt"); 
  fResEnergyGluonJet_eta1 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_gluon_eta1_7TeV.txt"); 
  fResEnergyElectron_eta1 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_electron_eta1_7TeV.txt"); 
  fResEnergyMuon_eta1     = new KLFitter::ResDoubleGaussPt("./../../transferfunctions/ttbar/par_energy_muon_eta1_7TeV.txt"); 
  fResEnergyPhoton_eta1   = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_energy_photon_eta1_7TeV.txt"); 

  fResEnergyLightJet_eta2 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_light_eta2_7TeV.txt"); 
  fResEnergyBJet_eta2     = new KLFitter::ResDoubleGaussE_2("./../../transferfunctions/ttbar/par_energy_b_eta2_7TeV.txt"); 
  fResEnergyGluonJet_eta2 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_gluon_eta2_7TeV.txt"); 
  fResEnergyElectron_eta2 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_electron_eta2_7TeV.txt"); 
  fResEnergyMuon_eta2     = new KLFitter::ResDoubleGaussPt("./../../transferfunctions/ttbar/par_energy_muon_eta2_7TeV.txt"); 
  fResEnergyPhoton_eta2   = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_energy_photon_eta2_7TeV.txt"); 

  fResEnergyLightJet_eta3 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_light_eta3_7TeV.txt"); 
  fResEnergyBJet_eta3     = new KLFitter::ResDoubleGaussE_2("./../../transferfunctions/ttbar/par_energy_b_eta3_7TeV.txt"); 
  fResEnergyGluonJet_eta3 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_gluon_eta3_7TeV.txt"); 
  fResEnergyElectron_eta3 = new KLFitter::ResDoubleGaussE_1("./../../transferfunctions/ttbar/par_energy_electron_eta3_7TeV.txt"); 
  fResEnergyMuon_eta3     = new KLFitter::ResDoubleGaussPt("./../../transferfunctions/ttbar/par_energy_muon_eta3_7TeV.txt"); 
  fResEnergyPhoton_eta3   = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_energy_photon_eta3_7TeV.txt"); 

  // eta resolution 
  fResEtaLightJet_eta1 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_light_eta1_7TeV.txt"); 
  fResEtaLightJet_eta2 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_light_eta2_7TeV.txt"); 
  fResEtaLightJet_eta3 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_light_eta3_7TeV.txt"); 

  fResEtaBJet_eta1 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_b_eta1_7TeV.txt"); 
  fResEtaBJet_eta2 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_b_eta2_7TeV.txt"); 
  fResEtaBJet_eta3 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_eta_b_eta3_7TeV.txt"); 

  // phi resolution 
  fResPhiLightJet_eta1 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_light_eta1_7TeV.txt"); 
  fResPhiLightJet_eta2 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_light_eta2_7TeV.txt"); 
  fResPhiLightJet_eta3 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_light_eta3_7TeV.txt"); 

  fResPhiBJet_eta1 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_b_eta1_7TeV.txt"); 
  fResPhiBJet_eta2 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_b_eta2_7TeV.txt"); 
  fResPhiBJet_eta3 = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_phi_b_eta3_7TeV.txt"); 

  // missing et resolution in x and y 
  fResMissingET      = new KLFitter::ResGauss("./../../transferfunctions/ttbar/par_misset_7TeV.txt"); 
