...
// ---------------------------------------------------------
KLFitter::ResDoubleGauss::ResDoubleGaussBase::ResDoubleGaussBase(const char * filename) : KLFitter::ResolutionBase(10) {
  // read parameters from file
  ReadParameters(filename, 10);
}

// ---------------------------------------------------------
KLFitter::ResDoubleGauss::ResDoubleGaussBase::ResDoubleGaussBase(std::vector<double> const& parameters) : KLFitter::ResolutionBase(parameters) {
...
// ---------------------------------------------------------
KLFitter::ResDoubleGauss::ResDoubleGaussBase::~ResDoubleGaussBase() = default;

// ---------------------------------------------------------
double KLFitter::ResDoubleGauss::ResDoubleGaussBase::GetSigma(double par) {
...
// ---------------------------------------------------------
double KLFitter::ResDoubleGauss::ResDoubleGaussBase::logp(double x, double xmeas, bool *good, double /*par*/) {
