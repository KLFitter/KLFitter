...
int KLFitter::InterfaceDummy::FillParticles()
{
	...
	fParticles -> AddParticle(lv = new TLorentzVector(fBhad_px, fBhad_py, fBhad_pz, fBhad_E), KLFitter::Particles::kParton, "jet 1"); fLorentzVectorContainer -> push_back(lv); 
	fParticles -> AddParticle(lv = new TLorentzVector(fBlep_px, fBlep_py, fBlep_pz, fBlep_E), KLFitter::Particles::kParton, "jet 2"); fLorentzVectorContainer -> push_back(lv); 
	fParticles -> AddParticle(lv = new TLorentzVector(fQup_px, fQup_py, fQup_pz, fQup_E), KLFitter::Particles::kParton, "jet 3"); fLorentzVectorContainer -> push_back(lv); 
	fParticles -> AddParticle(lv = new TLorentzVector(fQdown_px, fQdown_py, fQdown_pz, fQdown_E), KLFitter::Particles::kParton, "jet 4"); fLorentzVectorContainer -> push_back(lv); 
	fParticles -> AddParticle(lv = new TLorentzVector(fLepton_px, fLepton_py, fLepton_pz, fLepton_E), KLFitter::Particles::kElectron, "electron"); fLorentzVectorContainer -> push_back(lv); 
	fParticles -> AddParticle(lv = new TLorentzVector(fPhoton_px, fPhoton_py, fPhoton_pz, fPhoton_E), KLFitter::Particles::kPhoton, "photon"); fLorentzVectorContainer -> push_back(lv); 

	// create new truth particles container 
	fParticlesTruth = new KLFitter::Particles(); 

	// create Lorentz-vectors and add to list of particles 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Bhad_px, fTrue_Bhad_py, fTrue_Bhad_pz, fTrue_Bhad_E), KLFitter::Particles::kParton, "hadronic b quark"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Blep_px, fTrue_Blep_py, fTrue_Blep_pz, fTrue_Blep_E), KLFitter::Particles::kParton, "leptonic b quark"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Qup_px, fTrue_Qup_py, fTrue_Qup_pz, fTrue_Qup_E), KLFitter::Particles::kParton, "up-type quark"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Qdown_px, fTrue_Qdown_py, fTrue_Qdown_pz, fTrue_Qdown_E), KLFitter::Particles::kParton, "down-type quark"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Lepton_px, fTrue_Lepton_py, fTrue_Lepton_pz, fTrue_Lepton_E), KLFitter::Particles::kElectron, "electron"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Photon_px, fTrue_Photon_py, fTrue_Photon_pz, fTrue_Photon_E), KLFitter::Particles::kPhoton, "photon"); fLorentzVectorContainer -> push_back(lv); 
	fParticlesTruth -> AddParticle(lv = new TLorentzVector(fTrue_Neutrino_px, fTrue_Neutrino_py, fTrue_Neutrino_pz, fTrue_Neutrino_E), KLFitter::Particles::kNeutrino, "neutrino"); fLorentzVectorContainer -> push_back(lv); 
